...
def _migrate_columns(app):
    ...
    column_migrations = [
        ...
        ("predictions", "entry_range_low", "REAL"),
        ("predictions", "entry_range_high", "REAL"),
        ("users", "ai_insights_preferences", "TEXT"),
