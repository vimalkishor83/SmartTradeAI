...
export const MODULE_GROUPS = [
  {
    label: "Trading",
    items: [
      { id: "terminal", icon: "⚡", label: "Signal Terminal", real: true, premium: true, desc: "Live strategy signals, entries, stops, targets, confidence, and one-click paper trades." },
      { id: "trading-logs", icon: "\u{1F4D2}", label: "Trading Logs", real: true, premium: true, desc: "Your journalled paper trades — wins, losses, notes, CSV export." },
      { id: "backtest", icon: "\u{1F9EA}", label: "Backtest Lab", real: true, premium: true, desc: "Run and review strategy backtests and walk-forward validation." },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "scanner", icon: "⇄", label: "Bull/Bear Scanner", real: true, premium: true, desc: "Filter-driven scanner across the tracked asset universe." },
      { id: "regime-matrix", icon: "▩", label: "Market-Regime Matrix", real: false, desc: "Growth × inflation quadrant regime map." },
      { id: "portfolio", icon: "\u{1F4BC}", label: "Portfolio", real: true, premium: true, desc: "Your holdings, allocation, and CSV export." },
      { id: "watchlist", icon: "☆", label: "Watchlist", real: true, premium: true, desc: "Assets and context you're tracking." },
    ],
  },
  {
    label: "Economy",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "alerts", icon: "\u{1F514}", label: "Alerts", real: true, premium: true, desc: "Your notifications and alert history." },
      { id: "admin", icon: "⚙", label: "Admin Panel", real: true, premium: true, admin: true, desc: "User approval, API config, logs, and backups." },
    ],
  },
];
